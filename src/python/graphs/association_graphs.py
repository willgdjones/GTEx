...
for a in aggregations[0:1]:
	for (k, alph) in enumerate(alphas):
		...
		plt.plot(points, c='blue',label=alph, alpha=0.1+0.3*k)
plt.legend()
plt.savefig(GTEx_directory + '/graphs/sign_pvalues_vary_patchsize.png')
...
plt.tight_layout()
plt.savefig(GTEx_directory + '/graphs/sign_pvalues_raw_vs_retrained.png')
...
plt.tight_layout()
plt.savefig(GTEx_directory + '/graphs/sign_pvalues_mean_vs_median.png')
...
plt.legend()
plt.tight_layout()
plt.savefig(GTEx_directory + '/graphs/features_with_sign_transcripts.png')
...
plt.legend()
plt.tight_layout()
plt.savefig(GTEx_directory + '/graphs/transcripts_with_sign_features.png')
